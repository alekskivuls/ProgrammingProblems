package hackerRank.contests.thirtyDaysOfCode.day26Testing1;
...
public class Testing {
	public static void main(String[] args) {
		...
		System.out.println(calculateFine(returnDay, returnMo, returnYr, dueDay, dueMo, dueYr));
	}

	public static int calculateFine(int returnDay, int returnMo, int returnYr, int dueDay, int dueMo, int dueYr) {
		if (returnYr > dueYr) {
			return 10000;
		}
